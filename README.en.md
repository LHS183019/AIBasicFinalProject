...
```bash
git clone [https://github.com/YourUsername/AIBasicFinalProject.git](https://github.com/YourUsername/AIBasicFinalProject.git)
cd AIBasicFinalProject
````

  - You can also download it using other non-CLI methods.


```yaml
AIBasicFinalProject/   # You should be in this directory
├── basketball_coach/
│   ├── __init__.py
│   └── agent.py
├── requirements.txt
...
# Make sure you are in the project root directory (e.g., AIBasicFinalProject/).
...
```yaml
AIBasicFinalProject-main/   # In this directory
├── basketball_coach/
│   ├── __init__.py
│   └── agent.py
├── requirements.txt
